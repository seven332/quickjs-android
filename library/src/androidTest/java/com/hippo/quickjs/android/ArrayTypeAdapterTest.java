...
public class ArrayTypeAdapterTest {
  ...
  public void booleanArray() {
    ...
    assertException(
        ...
        boolean[].class,
        JSDataException.class,
        "Unexpected js tag " + JSContext.TYPE_FLOAT64 + " for pickle flag " + Translator.PICKLE_FLAG_TYPE_BOOLEAN
    );
    ...
    assertException(
        ...
        boolean[].class,
        JSDataException.class,
        "Unexpected js tag " + JSContext.TYPE_BOOLEAN + " for pickle flag " + Translator.PICKLE_FLAG_TYPE_ARRAY
    );
  ...
  public void stringArrayArray() {
    ...
    assertException(
        ...
        String[][].class,
        JSDataException.class,
        "Unexpected js tag " + JSContext.TYPE_OBJECT + " for pickle flag " + Translator.PICKLE_FLAG_TYPE_STRING
    );
  }
}
